...
print(f"Total number of loans is:", {total_loans})
...
average_loan = sum_of_all_loans / total_loans
...
print(f"remaining number of months is", {remaining_months})

loan_price = loan.get("loan_price")
print(f"the laon price is $", {loan_price})
...
present_value_of_new_loan = calculate_present_value(new_loan["future_value"], new_loan["remaining_months"], annual_discount_rate)
...
print("This is the inexpensive list", inexpensive_loans)
